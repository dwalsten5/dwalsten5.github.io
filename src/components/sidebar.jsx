	...
	return (
		<div id="sidebar">
			<div className="inner">
				...
				<footer id="footer">
					<p className="copyright">&copy; Doran Walsten. All rights reserved. Demo Images: <a href="https://unsplash.com">Unsplash</a>. Design: <a href="https://html5up.net">HTML5 UP</a>.</p>
				</footer>
			</div>
		</div>
	);
